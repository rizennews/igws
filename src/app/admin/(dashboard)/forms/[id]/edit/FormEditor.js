          ...
          <div className="hidden md:flex w-[250px] shrink-0 border-r border-[#E4E8F6] bg-[#FBFBFC] p-4 flex-col justify-between overflow-y-auto h-full select-none">
                    ...
                    return (
                      <div 
                        ...
                        className={`flex items-center justify-between p-2.5 rounded-xl border transition-all cursor-pointer group ${
                          activeStepIndex === idx 
                            ? 'bg-purple/10 border-purple/20 text-purple font-bold' 
                            : isDragOver
                              ? 'border-purple bg-purple/5'
                              : 'bg-white border-transparent hover:bg-light-gray/60 text-custom-text'
            ...
            <div className="border-t border-[#F1F2F6] pt-3 mt-3">
              ...
              >
                ...
                <div className="shrink-0 p-1 bg-light-gray rounded">
                  <svg className="w-3.5 h-3.5 text-navy" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 013.138-3.138z"></path></svg>
                </div>
