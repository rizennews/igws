...
export default function FormEditor({ formId, initialTitle, initialDescription, initialSlug, initialSchema, initialIsActive = true, initialEndDate = '' }) {
    ...
    <div className="flex gap-6 items-start">
      ...
      <div className="flex-1 bg-white border border-custom-border rounded-xl shadow-sm p-8">
        <div className="flex justify-between items-center mb-8 pb-6 border-b border-custom-border">
          <div>
            <h1 className="text-[22px] font-extrabold text-navy tracking-[0.02em]">Edit Form</h1>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 bg-off-white p-5 rounded-lg border border-custom-border">
          ...
          <div className="col-span-2">
            ...
            />
            <p className="text-[11px] text-muted mt-1">If set, the form will automatically close on this date, and all associated files will be securely deleted.</p>
          </div>
        </div>
      ...
      {success && (
        <div className="fixed inset-0 bg-black/20 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl px-10 py-8 w-full max-w-[400px] shadow-[0_20px_60px_rgba(0,0,0,0.08)] animate-fade-in relative text-center">
            ...
            <h3 className="text-2xl font-extrabold text-navy mb-2">Saved Successfully!</h3>
            <p className="text-[14px] text-[#52525b] mb-8 leading-snug px-2">
              Your changes have been saved. You can copy the link below.
            </p>
